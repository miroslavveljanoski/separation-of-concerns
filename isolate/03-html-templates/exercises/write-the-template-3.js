...
console.assert(_3_allEven === '<ul id="all-even"><li>2</li><li>4</li><li>6</li></ul>', 'Test 3: empty array');

const _4_mixed = renderEvens([1, 2, 3, 4, 5], 'mixed');
console.assert(_4_mixed === '<ul id="mixed"><li>2</li><li>4</li></ul>', 'Test 4: empty array');
